          ...
          return (
            ...
            >
              <div className="flex flex-col items-center">
                <div className={`relative rounded-full ${getGlowColor(translatedScore.score)} shadow-lg transition-all duration-700 group-hover:shadow-2xl group-hover:scale-105`}>
